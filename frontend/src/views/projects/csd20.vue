  ...
  <div class="csd20View">
    <section class="music-link-section" style="text-align: center; margin-top: 2rem">
      <router-link to="/project/csd20/music">
        <button class="music-btn">🎵 查看画册音乐特典</button>
      </router-link>
    </section>
      ...
      <main class="main-content">
        ...
        <div class="tech-box">
          ...
          <ul>
            ...
            <li>
              <strong>画师：</strong> 廻、靈、Crodelia、含烟、Arster_ 茶盒、幼月 73、白桦树
              AYA、前方路口请左转、4qw5、梅子、KINGDOM、青团、雪玲、降旗原、七年藤、火球子、Interboat、Bwaity、兜转、雷花啤酒、3
              皮君、早景 zaojing、木亚措
            </li>
